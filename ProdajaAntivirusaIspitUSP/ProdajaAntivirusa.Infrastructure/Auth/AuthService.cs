...
//user.Claims.Add(new MongoClaim { Type = ClaimTypes.Surname, Value = createUserDto.LastName });
//user.Claims.Add(new MongoClaim { Type = ClaimTypes.Name, Value = createUserDto.FirstName });